...
<div>
    ...
    <div id="div3">
        <center>
            ...
            <!-- Form to input faculty ID -->
            <form action="Admin_view_FOF.jsp" method="get">
                <div class="container">
                    <div class="form-group">
                        <label for="fid">Enter Faculty ID:</label>
                        <input type="text" id="fid" name="fid" placeholder="Enter Faculty ID" required>
                    </div>
                    <button type="submit" class="but">Get Sections and Subjects</button>
                </div>
            </form><br><br>
            ...
            <%
                    ...
                    out.println("<p>Faculty ID not provided or invalid.</p>");
                }
            %>
        </center>
    </div>
